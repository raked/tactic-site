    ...
    return (
        <div>
            <section id="music" className="bg-dark">
                ...
                <div className="d-flex flex-column flex-lg-row text-center justify-content-center align-items-center min-vh-100">
                    <div className="p-3">
            ...
            <section id="contact" className="bg-dark">
                <div className="container text-center p-3">
                    <a href="https://soundcloud.com/andyv15" target="_blank" rel="noreferrer">
                        <img src="assets/images/logo.png" alt="Soundcloud logo" style={{ maxHeight: "100px" }} />
                    </a>
                </div>
            </section>
        </div>
